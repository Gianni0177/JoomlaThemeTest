...
?>
<figure class="<?php echo $this->escape($imgclass); ?> item-image figure">
    ...
    <?php if (isset($images->image_fulltext_caption) && $images->image_fulltext_caption !== '') : ?>
        <figcaption class="figure-caption text-center pt-3"><?php echo $this->escape($images->image_fulltext_caption); ?></figcaption>
    <?php endif; ?>
</figure>
