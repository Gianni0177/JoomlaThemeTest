...
switch ((string) $item->text) {
    ...
    case Text::_('JLIB_HTML_START'):
        $icon = $app->getLanguage()->isRtl() ? 'fa-solid fa-chevrons-right' : 'fa-solid fa-chevrons-left';
    ...
    case Text::_('JLIB_HTML_END'):
        $icon = $app->getLanguage()->isRtl() ? 'fa-solid fa-chevrons-left' : 'fa-solid fa-chevrons-right';
        $aria = Text::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
        break;
