...
$catIconId = findObjectByName($currentCatFields, "icon-class")->value;


$summary = findObjectByName($this->item->jcfields, "summary")->value;
$datestart = (findObjectByName($this->item->jcfields, "datestart")) ? findObjectByName($this->item->jcfields, "datestart")->value : null;


$introimg = findObjectByName($this->item->jcfields, "introimg")->value;
$introimg = str_replace('src="','class="img-fluid" src="', $introimg);
