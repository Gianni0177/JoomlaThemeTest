...
<form action="<?php echo Route::_($this->query->toUri()); ?>" method="get" class="js-finder-searchform">
    ...
    <fieldset class="com-finder__search word mb-3">
        <legend class="com-finder__search-legend d-none text-black bg-white h3 p-0">
        ...
        <div class="form-inline">
            ...
            <div class="input-group">
                <input type="text" name="q" id="q" autocomplete="off" class="js-finder-search-query form-control" value="<?php echo $this->escape($this->query->input); ?>">
