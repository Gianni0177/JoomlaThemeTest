...
class GeraintViewNavTableBarIconic extends DefaultViewNavTableBarIconic
{
	...
	function __construct($view, $today_date, $view_date, $dates, $alts, $option, $task, $Itemid)
	{
		...
		?>
		<div class="ev_navigation d-flex justify-content-center">
					<?php
					...
					<?php if (in_array("byyear", $this->iconstoshow)) { ?>
						<div class="px-2 text-center"><?php echo $this->_viewYearIcon($view_date);?><div><?php echo Text::_('JEV_VIEWBYYEAR'); ?></div></div><?php } ?>
					<?php if (in_array("bymonth", $this->iconstoshow)) { ?>
						<div class="px-2 text-center"><?php echo $this->_viewMonthIcon($view_date); ?><div><?php echo Text::_('JEV_VIEWBYMONTH'); ?></div></div><?php } ?>
					<?php if (in_array("byweek", $this->iconstoshow)) { ?>
						<div class="px-2 text-center"><?php echo $this->_viewWeekIcon($view_date); ?><div><?php echo Text::_('JEV_VIEWBYWEEK'); ?></div></div><?php } ?>
					<?php if (in_array("byday", $this->iconstoshow)) { ?>
						<div class="px-2 text-center"><?php echo $this->_viewDayIcon($today_date); ?><div><?php echo Text::_('JEV_VIEWTODAY'); ?></div></div><?php } ?>
					<?php if (in_array("search", $this->iconstoshow)) { ?>
						<div class="px-2 text-center"><?php echo $this->_viewSearchIcon($view_date); ?><div><?php echo Text::_('JEV_SEARCH_TITLE'); ?></div></div><?php } ?>
					<?php if (in_array("bymonth", $this->iconstoshow)) { ?>
						<div class="px-2 text-center"><?php echo $this->_viewJumptoIcon($view_date);?><div><?php echo Text::_('JEV_JUMPTO'); ?></div></div><?php } ?>
